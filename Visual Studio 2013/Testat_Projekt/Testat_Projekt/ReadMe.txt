========================================================================
    KONSOLENANWENDUNG: Testat_Projekt-Projektübersicht
========================================================================

Diese Testat_Projekt-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Testat_Projekt-Anwendung besteht.


Testat_Projekt.vcxproj
...
Testat_Projekt.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Testat_Projekt.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
